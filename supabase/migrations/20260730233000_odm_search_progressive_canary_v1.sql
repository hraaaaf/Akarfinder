-- ODM SEARCH PROGRESSIVE CANARY V1
-- Deterministic cumulative Shadow cohorts over Search Assembly V1.
...
revoke all on function public.odm_search_progressive_canary_report_v1() from public,anon,authenticated;
grant execute on function public.odm_search_progressive_canary_report_v1() to service_role;
comment on function public.odm_search_progressive_canary_report_v1() is 'Deterministic service-role-only progressive Shadow canary report at 1, 5, 10 and 25 percent.';