...
export function GoogleLikeHero() {
  return (
    <section
      ...
      className="relative overflow-hidden bg-[#061027]"
    >
      <picture>
      ...
      <div className="pointer-events-none absolute inset-0" aria-hidden="true">
        <div className="absolute inset-0 bg-[linear-gradient(90deg,rgba(3,16,31,0.76)_0%,rgba(3,16,31,0.56)_48%,rgba(3,16,31,0.34)_100%)]" />
        <div className="absolute inset-0 bg-gradient-to-b from-[rgba(3,16,31,0.32)] via-transparent to-[rgba(3,16,31,0.44)]" />
        <div className="absolute inset-0 bg-[#061027]/10" />
      </div>

      <Container className="relative z-10 w-full px-5 py-9 sm:py-11 lg:py-12 xl:py-14">
        <div
          data-home-hero-layout="hvr-1"
          className="mx-auto grid max-w-[1320px] items-center gap-7 lg:grid-cols-[minmax(0,1.34fr)_minmax(330px,0.66fr)] lg:gap-8 xl:gap-10"
        >
          <div className="min-w-0 text-center lg:text-left">
            ...
            <h1
              id="home-hero-title"
              className="mx-auto mt-3 max-w-[900px] text-[2.45rem] font-extrabold leading-[1.02] tracking-[-0.05em] text-white drop-shadow-[0_4px_20px_rgba(0,0,0,0.38)] sm:text-[3.45rem] lg:mx-0 lg:mt-4 lg:text-[3.55rem] xl:text-[3.9rem]"
            >
