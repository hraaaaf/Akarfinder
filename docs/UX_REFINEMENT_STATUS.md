...
| P1 LOT 2 — Design-system convergence | TODO | Remaining legacy colors, spacing, semantic states and dark-mode consistency | — |
...
- P1 current refinement: **25%**
- Overall current UX refinement program: **about 59%**
