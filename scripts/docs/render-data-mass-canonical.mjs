...
r = r.replace("**Version : 2026-08-12**", "**Version : 2026-08-13**");
r = r.replace(/^\*\*Statut :.*\*\*$/m, "**Statut : MASS-2 ✅ CLOSED / 100 % ; MASS-3A ✅ CLOSED ; MASS-3B ✅ CLOSED ; MASS-3C 🔄 Canary Readiness read-only.**");
