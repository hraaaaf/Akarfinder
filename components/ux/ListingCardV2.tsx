...
export function ListingCardV2({ listing, position }: { listing: Listing; position?: number }) {
  ...
  return (
    ...
    >
      <div className="relative min-h-[218px] overflow-hidden bg-slate-100">
        {image ? (
          <div
          ...
          <div className="grid h-full min-h-[218px] place-items-center bg-gradient-to-br from-slate-100 via-blue-50 to-slate-200 text-slate-400">
            <div className="text-center">
              <Building2 className="mx-auto" size={46} strokeWidth={1.4} />
              <p className="mt-2 text-[11px] font-extrabold uppercase tracking-[.12em]">
                Visuel non publié
              </p>
            </div>
          </div>
