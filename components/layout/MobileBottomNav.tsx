...
export function MobileBottomNav() {
  ...
  return (
    <nav
      ...
      data-theme="light"
      className="fixed bottom-[calc(8px+env(safe-area-inset-bottom))] left-[10px] right-[10px] z-[70] overflow-hidden rounded-[22px] border border-white/80 bg-white/80 text-[#0B2545] shadow-[0_10px_28px_rgba(15,23,42,0.12),0_2px_8px_rgba(15,23,42,0.06)] backdrop-blur-[20px] supports-[backdrop-filter]:bg-white/74 md:hidden"
    >
