...
G2 | 85->87% | FRESHNESS-OBSERVATION-SCORE-1 | lecture prudente de fraicheur/observation sur les resultats Gateway externes, sans promesse de disponibilite, sans persistance reelle (abstraction only) | CODE+TESTS+BUILD VALIDES 2026-07-06 | G prod | sur-promesse de disponibilite/fiabilite si labels mal filtres | preview a deployer, prod en attente de GO explicite
