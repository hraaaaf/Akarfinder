...
function commonsSource(fileName: string, details: {
  ...
  return {
    ...
    locationEvidenceUrl: details.locationEvidenceUrl,
  } as const;
}
...
function kartaViewSource(details: {
  ...
  return {
    ...
    license: "CC BY-SA 4.0",
    rightsBasis: "cc_by_sa_4_0" as const,
    rightsNote: "KartaView street imagery is reused under CC BY-SA 4.0 with attribution to © Grab and KartaView Contributors.",
    capturedAt: details.capturedAt,
    width: 1280,
    height: 720,
    bytes: details.bytes,
...
export const AKKARI_SIGNATURE_VISUAL = {
  ...
  truthBoundary: {
    ...
    allowedMeaning: "Recognizable public landmark of Akkari only",
  },
} as const;

export const AKKARI_IMMOBILIER_VISUAL = {
  ...common,
  id: "rabat-akkari-immobilier-v1",
  ...
  source: kartaViewSource({
    photoId: 260132875,
    sequenceId: 1224587,
    asset: "https://storage13.openstreetcam.org/files/photo/2018/5/22/proc/2832730_479bad4edbb80a6bec06b52502e18f2e.jpg",
    capturedAt: "2018-05-22 13:22:03",
    latitude: 34.008988,
    longitude: -6.862511,
    heading: 140,
    bytes: 270_159,
    sha1: "2466f43109b1f2b0b5c55b4acca2a59585a7438e",
    sourceNote: "The exact 1280×720 fileurlLTh rendition is certified unchanged as neighborhood built morphology, never as a listing-specific property.",
  }),
  truthBoundary: {
    depictsSpecificProperty: false,
...
export const AKKARI_LIFESTYLE_VISUAL = {
  ...
  source: kartaViewSource({
    photoId: 260133961,
    sequenceId: 1224599,
    asset: "https://storage13.openstreetcam.org/files/photo/2018/5/22/proc/2833707_bf541ee984ec833564dedfdb5d056a29.jpg",
    capturedAt: "2018-05-22 12:49:35",
    latitude: 34.009151,
    longitude: -6.86069,
    heading: 214,
    bytes: 251_579,
    sha1: "015123bef3d8a5c98d9f31ab3f3a581272a6ae4e",
    sourceNote: "The exact 1280×720 fileurlLTh rendition is certified unchanged as public local-life context, never as a property amenity.",
  }),
  truthBoundary: {
    depictsSpecificProperty: false,
...
export const AKKARI_NEIGHBORHOOD_VISUALS = [
  AKKARI_SIGNATURE_VISUAL,
  AKKARI_IMMOBILIER_VISUAL,
  AKKARI_LIFESTYLE_VISUAL,
] as const;
