...
Main canonique après P1B.7 : `77bd6ffad41443efbf543cd25caf7539ca593579` — merge PR #426, incluant le `main` Search `6bcf402158539c547061a6a92d1b408df1da8d22`. P1B.7 est strictement read-only ; exact-head final `d76eeda4de755faf08ec90afdaa0989cd4e8f2de`, **19/19 workflows verts**, specialized live gate PASS, Reviewer **9,6/10**, Release Certifier GO, post-merge gate PASS.
