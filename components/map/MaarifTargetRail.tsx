  ...
  return (
    <aside className="maarif-target-rail" data-maarif-target-rail>
      ...
      <section className="maarif-target-copy">
        ...
        <Link
          href="/search?city=Casablanca&district=Ma%C3%A2rif"
          className="maarif-target-search-cta"
          data-maarif-search-cta
        >
          Voir les biens disponibles à Maârif
        </Link>
      </section>
      ...
      <style jsx global>{`
        ...
        .maarif-target-copy{padding:15px 22px 8px}.maarif-target-copy p{margin:0;font-size:12px;line-height:1.48;color:#58625e}.maarif-target-search-cta{display:flex;align-items:center;justify-content:center;min-height:42px;margin-top:12px;border-radius:13px;background:#0b2747;color:#fff;text-decoration:none;font-size:10px;font-weight:850;letter-spacing:.01em;box-shadow:0 8px 20px rgb(11 39 71/.14)}
