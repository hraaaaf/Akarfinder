...
const rows=await get('source_policy_registry',{select:'source_domain,authorization_status,display_policy,display_gate,acquisition_mode,ingestion_gate',source_domain:`in.(${targets.join(',')})`});
