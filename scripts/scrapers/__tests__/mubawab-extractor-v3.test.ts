...
<script type="application/ld+json">{"@type":"Product","name":"Local commercial titré à Derb Omar","offers":{"price":"2500000","priceCurrency":"MAD"},"address":{"addressLocality":"Casablanca","streetAddress":"Derb Omar"},"floorSize":{"value":107},"description":"Local commercial titré idéalement situé au cœur de Derb Omar."}</script></body></html>`;
  ...
  it("recognizes standalone vente wording in the primary description", () => {
    const html = `<!doctype html><html><head><meta property="og:title" content="Appartement 116 m² — Crêtes de Californie"></head><body><div>1 900 000 DH</div><div>116 m²</div><div>Casablanca</div><h1>Appartement 116 m² — Crêtes de Californie</h1><script type="application/ld+json">{"@type":"Apartment","name":"Appartement 116 m² — Crêtes de Californie","offers":{"price":"1900000"},"address":{"addressLocality":"Casablanca"},"floorSize":{"value":116},"description":"Très bel appartement traversant. Vente pour cause d'achat plus grand."}</script></body></html>`;
    const listing = extractMubawabCollectionListing("https://www.mubawab.ma/fr/a/8399780/appartement-116-m2-cretes-de-californie", html, "2026-09-03T18:45:00.000Z");
    assert.equal(listing.transaction, "sale");
    assert.equal(listing.price.period, "total");
  });
