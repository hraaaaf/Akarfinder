...
function CityLink({ city }: { city: CityConfig }) {
  return (
    ...
    >
      ...
      <p className="mt-1.5 line-clamp-1 text-[9.5px] font-semibold uppercase tracking-[0.08em] text-slate-400">
        {city.tag}
      </p>
    </Link>
  );
        ...
        <div className="mx-auto max-w-[1240px]">
          <div className="flex items-end justify-between gap-6">
            <div>
              ...
              <h2 className="mt-2 text-[1.8rem] font-extrabold tracking-[-0.04em] text-[#0B1F3A] sm:text-[2.35rem]">
                Villes populaires
              </h2>
              <p className="mt-2 max-w-[610px] text-[0.88rem] leading-6 text-slate-600 sm:text-[0.96rem]">
                Entrez par une ville, puis laissez le moteur faire le reste.
              </p>
            </div>
            <Link href="/immobilier" className="hidden text-[12px] font-extrabold text-[#0B63CE] hover:underline sm:inline-flex">
              Toutes les villes
            </Link>
          </div>
