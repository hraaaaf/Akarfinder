...
export const GEO_NEIGHBORHOODS: CanonicalNeighborhoodEntity[] = [
  ...
  { id: "district_rabat_akkari", slug: "akkari", canonical_name: "Akkari", aliases: ["Aakari"], city_slug: "rabat", validation_status: "validated", seo_eligible: false, map_eligible: true },
