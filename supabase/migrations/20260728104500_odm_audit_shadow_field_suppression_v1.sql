-- ODM-AUDIT-PILOT-01 correction:
-- canonical-link eligibility and structured-field eligibility are separate.
-- An authorized link may remain a candidate while ambiguous/unconfirmed economics
-- are suppressed from the shadow projection.
