...
export const GEO_NEIGHBORHOODS: CanonicalNeighborhoodEntity[] = [
  ...
  { id: "district_rabat_yacoub_el_mansour", slug: "yacoub-el-mansour", canonical_name: "Yacoub El Mansour", aliases: ["Yacoub Al Mansour", "Yaacoub El Mansour"], city_slug: "rabat", validation_status: "validated", seo_eligible: false, map_eligible: true },
