...
const MARKET_POSITION_COLOR: Record<DemoMarketPositionLabel, string> = {
  "Position relative inférieure": "text-emerald-600 bg-emerald-50 border-emerald-200",
  "Position relative proche": "text-[#0B63CE] bg-[#0B63CE]/10 border-[#0B63CE]/25",
  "Position relative supérieure": "text-amber-600 bg-amber-50 border-amber-200",
