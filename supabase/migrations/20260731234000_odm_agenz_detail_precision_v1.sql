-- ODM AGENZ DETAIL PRECISION V1
-- Promote only explicit Agenz listing-detail URLs from AMBIGUOUS to LISTING.

create or replace function public.refresh_odm_agenz_detail_precision_v1()
returns jsonb
language plpgsql
security invoker
set search_path = ''
...
begin
  ...
  set
    ...
    document_kind_reason = 'agenz_explicit_listing_detail_url',
    document_kind_version = 'odm_agenz_detail_precision_v1',
    ...
    ranking_policy_version = 'odm_agenz_detail_precision_v1'
  where d.source_domain = 'agenz.ma'
  ...
  return jsonb_build_object(
    'version', 'odm_agenz_detail_precision_v1',
...
revoke all on function public.refresh_odm_agenz_detail_precision_v1() from public, anon, authenticated;
grant execute on function public.refresh_odm_agenz_detail_precision_v1() to service_role;

create or replace view public.odm_agenz_detail_precision_report_v1
...
where source_domain = 'agenz.ma'
  and vertical_classification = 'real_estate_likely';

revoke all on public.odm_agenz_detail_precision_report_v1 from public, anon, authenticated;
grant select on public.odm_agenz_detail_precision_report_v1 to service_role;
