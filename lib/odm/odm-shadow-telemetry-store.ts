...
export function metricToTelemetryRow(metric: OdmDualReadDivergence) {
  return {
    ...
    context_has_text_query: metric.context_has_text_query,
    context_has_price_filter: metric.context_has_price_filter,
    context_has_surface_filter: metric.context_has_surface_filter,
    context_limit: metric.context_limit,
    context_offset: metric.context_offset,
    context_is_paginated: metric.context_is_paginated,
