-- MASS-INDEX M7-E recovery — canonical-link-only public search
-- Objective: restore Google-like minimal indexing after the strict M7 policy guard while keeping protected source content fail-closed.
-- Preconditions: 20260824091000_m7_public_search_policy_guard.sql is applied.
-- Impact: replaces the serving RPC only; no source/index/policy row is modified.
