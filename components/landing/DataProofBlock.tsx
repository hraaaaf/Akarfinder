...
const proofPoints = [
  {
    ...
    description: "Vous savez toujours d’où vient l’annonce.",
  },
  {
    key: "information",
    number: "02",
    title: "Détails utiles en un coup d’œil",
    description: "Prix, localisation et caractéristiques restent faciles à lire.",
  },
  {
    key: "similar",
    number: "03",
    title: "Résultats proches mieux organisés",
    description: "Les offres proches sont rapprochées pour comparer plus facilement.",
  },
] as const;
          ...
          <div className="grid gap-8 lg:grid-cols-[0.82fr_1.18fr] lg:items-end lg:gap-14">
            <div>
              ...
              <h2 id="home-data-proof-title" className="mt-3 text-[2rem] font-extrabold leading-[1.08] tracking-[-0.04em] text-white sm:mt-4 sm:text-[2.75rem]">
                Comparez sans perdre l’essentiel
              </h2>
              <p className="mt-4 max-w-[620px] text-[14.5px] leading-7 text-white/72 sm:text-[15.5px]">
                Chaque résultat met en avant la source, le prix, la localisation et les caractéristiques utiles.
              </p>
            </div>
            ...
            <div className="rounded-[1.75rem] border border-white/12 bg-[linear-gradient(135deg,rgba(255,255,255,0.09),rgba(255,255,255,0.035))] p-5 shadow-[0_26px_70px_rgba(0,0,0,0.22)] sm:p-7">
              <div className="flex items-start justify-between gap-4 border-b border-white/10 pb-5">
                <div>
                  <p className="text-[11px] font-extrabold uppercase tracking-[0.14em] text-[#7DD3FC]">Exemple</p>
                  <p className="mt-2 text-[1.25rem] font-extrabold tracking-[-0.025em] text-white">Appartement · Agdal</p>
                </div>
                <span className="rounded-full border border-white/12 bg-white/[0.07] px-3 py-1.5 text-[11px] font-bold text-white/75">Détails utiles</span>
              </div>
              <div className="mt-5 grid grid-cols-3 gap-2.5">
                {["Localisation", "Caractéristiques", "Source"].map((label) => (
              ...
              <div className="mt-5 flex items-center justify-between border-t border-white/10 pt-4 text-[12px]">
                <span className="font-semibold text-white/60">Résultats proches</span>
