...
describe("Mubawab Lot 3 extractor", () => {
  it("maps /a/ detail HTML into the collection contract", () => {
    ...
    assert.ok(listing.images.length >= 1);
  });
