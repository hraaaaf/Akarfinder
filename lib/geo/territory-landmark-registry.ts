...
export const VERIFIED_LANDMARKS: readonly VerifiedLandmarkEntry[] = [
  ...
  {
    entity: {
      id: "landmark_nador_hay_aarid_mosquee_arrid_stop",
      type: "landmark",
      citySlug: "nador",
      districtSlug: "hay-aarid",
      landmarkSlug: "l3-mosquee-arrid",
      canonicalName: "L3 Mosquée Arrid",
      aliases: ["Mosquée Arrid"],
      category: "transport",
      parentId: "district_nador_hay_aarid",
      importance: { score: 84, tier: "regional", basis: ["orientation_value", "product_priority"] },
      visibility: { minZoom: 14.0, retainPriority: false },
      coordinates: { lat: 35.15748, lng: -2.93685, precision: "verified_landmark_point" },
    },
    sourceRefs: [
      "https://yakeey.com/fr-ma/referentiel-de-prix-immobilier/nador",
      "https://mapcarta.com/N10007578688",
    ],
    verificationNote: "Yakeey exposes Hay Aarid in the Nador product taxonomy; the Vectalia Nador stop L3 Mosquée Arrid preserves the exact local toponym and OSM-backed Mapcarta supplies the verified point.",
    verifiedAt: "2026-09-22",
  },
  {
    entity: {
      id: "landmark_bouznika_hay_salim_pharmacie",
      type: "landmark",
      citySlug: "bouznika",
      districtSlug: "hay-salim",
      landmarkSlug: "pharmacie-salim",
      canonicalName: "Pharmacie Salim",
      aliases: [],
      category: "other",
      parentId: "district_bouznika_hay_salim",
      importance: { score: 76, tier: "local", basis: ["orientation_value", "product_priority"] },
      visibility: { minZoom: 14.4, retainPriority: false },
      coordinates: { lat: 33.78495, lng: -7.16383, precision: "verified_landmark_point" },
    },
    sourceRefs: [
      "https://yakeey.com/fr-ma/referentiel-de-prix-immobilier/bouznika",
      "https://mapcarta.com/N8505135435",
    ],
    verificationNote: "Yakeey exposes Hay Salim in the Bouznika product taxonomy; the namesake Pharmacie Salim is a stable local orientation POI in Bouznika and OSM-backed Mapcarta supplies its verified point. It is deliberately scored as a local landmark.",
    verifiedAt: "2026-09-22",
  },
  {
    entity: {
      id: "landmark_bouznika_al_wouroud_pharmacie",
      type: "landmark",
      citySlug: "bouznika",
      districtSlug: "al-wouroud",
      landmarkSlug: "pharmacie-el-woroud",
      canonicalName: "Pharmacie El Woroud",
      aliases: ["Pharmacie Al Wouroud"],
      category: "other",
      parentId: "district_bouznika_al_wouroud",
      importance: { score: 76, tier: "local", basis: ["orientation_value", "product_priority"] },
      visibility: { minZoom: 14.4, retainPriority: false },
      coordinates: { lat: 33.7676, lng: -7.15973, precision: "verified_landmark_point" },
    },
    sourceRefs: [
      "https://yakeey.com/fr-ma/referentiel-de-prix-immobilier/bouznika",
      "https://mapcarta.com/N8504583674",
    ],
    verificationNote: "Yakeey exposes Al Wouroud in the Bouznika product taxonomy; the namesake Pharmacie El Woroud is a stable local orientation POI in Bouznika and OSM-backed Mapcarta supplies its verified point. It is deliberately scored as a local landmark.",
    verifiedAt: "2026-09-22",
  },
  {
    entity: {
      id: "landmark_bouznika_hay_amal_pharmacie",
      type: "landmark",
      citySlug: "bouznika",
      districtSlug: "hay-amal",
      landmarkSlug: "pharmacie-al-amal",
      canonicalName: "Pharmacie Al Amal",
      aliases: [],
      category: "other",
      parentId: "district_bouznika_hay_amal",
      importance: { score: 76, tier: "local", basis: ["orientation_value", "product_priority"] },
      visibility: { minZoom: 14.4, retainPriority: false },
      coordinates: { lat: 33.78241, lng: -7.15777, precision: "verified_landmark_point" },
    },
    sourceRefs: [
      "https://yakeey.com/fr-ma/referentiel-de-prix-immobilier/bouznika",
      "https://mapcarta.com/N8505072368",
      "https://www.annuaire-gratuit.ma/pharmacies/pharmacie-al-amal-s246828.html",
    ],
