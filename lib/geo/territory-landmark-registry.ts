...
export const VERIFIED_LANDMARKS: readonly VerifiedLandmarkEntry[] = [
  ...
  { entity: { id: "landmark_marrakech_sidi_ghanem_lrnce", type: "landmark", citySlug: "marrakech", districtSlug: "sidi-ghanem", landmarkSlug: "lrnce-studio", canonicalName: "LRNCE Studio", aliases: ["LRNCE"], category: "other", parentId: "district_marrakech_sidi_ghanem", importance: { score: 87, tier: "major", basis: ["orientation_value","product_priority"] }, visibility: { minZoom: 13.9, retainPriority: false }, coordinates: { lat: 31.6761604, lng: -8.0481564, precision: "verified_landmark_point" } }, sourceRefs: ["https://lrnce.com/our-studio/","https://www.discovermarrakech.city/en/place/lrnce-studio"], verificationNote: "Official studio address + independent Sidi Ghanem corroboration and factory GPS evidence.", verifiedAt: "2026-09-19" },
