      ...
      <div className="flex min-w-0 flex-col p-5">
        <div className="flex items-start justify-between gap-3">
          <div className="min-w-0">
            ...
            <h2 className="mt-1 line-clamp-2 text-[16px] font-extrabold leading-6 text-slate-800">{listing.title}</h2>
        ...
        <div className="mt-auto flex flex-wrap items-end justify-between gap-3 border-t border-slate-100 pt-4 text-[11px] text-slate-500">
          <p>Source : <strong className="text-slate-700">{source}</strong>{listing.freshness_label ? <><span className="mx-2">·</span>{listing.freshness_label}</> : null}</p>
