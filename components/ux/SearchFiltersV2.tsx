  ...
  return (
    <>
      <aside className="hidden border-r border-slate-200 bg-white p-5 lg:block">
        <form action="/search" className="space-y-5"><div className="flex items-center justify-between"><h2 className="text-lg font-black">Filtres</h2><a href="/search" className="text-xs font-extrabold text-blue-700">Réinitialiser</a></div><FilterFields/><button className="h-11 w-full rounded-xl bg-blue-700 text-sm font-extrabold text-white">Voir {total} résultats</button></form>
      </aside>
