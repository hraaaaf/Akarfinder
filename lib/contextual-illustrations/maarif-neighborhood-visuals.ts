...
export const MAARIF_IMMOBILIER_VISUAL = {
  ...
  source: {
    ...
    asset: "https://storage8.openstreetcam.org/files/photo/2018/5/1/lth/1173831_da367_6186.jpg",
    sourcePage: "https://kartaview.org/",
    sourceName: "KartaView",
    sourceKind: "open_license" as const,
    author: "KartaView contributors / Grab",
    license: "CC BY-SA 4.0",
    rightsBasis: "cc_by_sa_4_0" as const,
    rightsNote: "KartaView imagery reused under CC BY-SA 4.0 with attribution and ShareAlike.",
    width: 1280,
    height: 720,
    bytes: 413452,
